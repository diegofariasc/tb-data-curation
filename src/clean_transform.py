...
def detect_metadata_rows(
    ...
    """Detect the row with the header by searching for a keyword."""
...
def clean_and_transform(
    ...
    # Dynamically detect numeric vs metadata columns
    ...
    # Try to convert numeric column names to Year if possible
    try:
